...
card1 = {:id => 1, :name => "Celtic Guardian", :type => "monster", :desc => "An elf who learned to wield a sword, he baffles enemies with lightning-swift attacks.", :atk => 1400, :def => 1200, :level => 4, :effect => "", :file => "../Resources/Images/CelticGuardian.jpg"}
