...
card1 = {:id => 1, :name => "Celtic Guardian", :type => "monster", :desc => "An elf who learned to wield a sword, he baffles enemies with lightning-swift attacks.", :atk => 1400, :def => 1200, :level => 4, :effect => "", :file => "Images/CelticGuardian.jpg"}
...
card4 = {:id => 4, :name => "Spike Seadra", :type => "monster", :desc => "Using the spikes sprouting from its body, this creature stabs its opponents and floods them with electricity.", :atk => 1600, :def => 1300, :level => 5, :effect => "", :file => "Images/SpikeSeadra.jpg"}
...
card6 = {:id => 6, :name => "Giant Soldier of Stone", :type => "monster",:desc => "A giant warrior made of stone. A punch from this creature has earth-shaking results.", :atk => 1300, :def => 2000, :level => 3, :effect => "", :file => "Images/GiantSoldierofStone.jpg"}
...
card8 = {:id => 8, :name => "Obnoxious Celtic Guard", :type => "monster",:desc => "This card cannot be destroyed by battle with a monster that has 1900 or more ATK.",:atk => 1400, :def => 1200, :level => 4, :effect => "", :file => "Images/ObnoxiousCelticGuardian.jpg"}
#Obnoxious Celtic Guardian STATUS: working
card9 = {:id => 9, :name => "Summoned Skull", :type => "monster",:desc => "A fiend with dark powers for confusing the enemy. Among the Fiend-Type monsters, this monster boasts considerable force.",:atk => 2500, :def => 1200, :level => 6, :effect => "", :file => "Images/SummonedSkull.jpg"}
#Summoned Skull STATUS: working
card10 = {:id => 10, :name => "Dark Magician", :type => "monster",:desc => "The ultimate wizard in terms of attack and defense.", :atk => 2500, :def => 2100, :level => 7, :effect => "", :file => "Images/DarkMagician.jpg"}
